...
function HomePage() {
  ...
  const pieChartData = [
    { name: 'Inspection', value: 100 },
    { name: 'Available', value: 500 },
    { name: 'Trading', value: 350 },
    { name: 'Sold', value: 250 }
  ]
          ...
          <MainSection>
            <Filter>
              ...
              <FilterCTA>
                ...
                <Radio checked={yearOnlyFilter} onClick={updateYearOnlyFilter} color="secondary" style={{ marginLeft: '10px' }} />
