...
function UsersPage() {
    ...
    const retrieveUsers = ({tradeStatus = '', page = 0, status = '', approvedStatus = ''}) => {
        setPageLoading(true)
        setUsers([])
        setPagination({
            "count": 0,
        ...
        merchantService.retrieveMerchants(rowsPerPage, page, tradeStatus, '', status, approvedStatus)
            .then((response) => {
                if (response.status) {
                    ...
                    <Flex>
                        ...
                        <StatsCard
                            onClick={() => {
                                ...
                                setPage(0);
                                retrieveUsers({approvedStatus: 'pending'})
                            }}
                            style={{
                                border:
