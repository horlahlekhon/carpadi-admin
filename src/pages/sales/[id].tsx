...
function SalesProfilePage({ pageId }) {
  ...
  function saveSale() {
    ...
    const newFeatures = sale.car_features.filter((x) => x?.id == null)
    if (newFeatures.length > 0) {
      body['features'] = newFeatures
    }
              ...
              <ActionBar>
                ...
                <div className="button-group">
                  ...
                  <Button
                    ...
                    marginRight="16px"
                    onClick={() =>
                      showModal('editImages', 'Edit Car Sales Images')
                    }
                  />
                  <Button
                    text="Edit Details"
                    ...
                    outlined={true}
                    onClick={() =>
                      showModal('editDetails', 'Edit Car Sales Details')
                    }
                  />
                </div>
              </ActionBar>
