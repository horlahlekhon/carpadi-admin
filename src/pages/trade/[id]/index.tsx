...
function TradeProfilePage() {
    ...
    const deleteTrade = () => {
        setModalState(false)
        tradeService.deleteSingleTrade(tradeId)
            .then((response) => {
                if (response.status) {
    ...
    const saveTrade = () => {
        setModalState(false)
        tradeService.updateSingleTrade(tradeId, {...tradeData, car: tradeData.car.id})
            .then((response) => {
                if (response.status) {
    ...
    const retrieveTrade = () => {
        tradeService.retrieveSingleTrade(tradeId)
            .then((response) => {
                if (response.status) {
                ...
                <ActionBar>
                    ...
                    <div className="button-group">
                        ...
                        <Button
                            ...
                            width={150}
                            outlined={true}
                            onClick={() => handleNavigation(`/inventory/car-profile/${tradeData.car.id}?status=car listings`)}
                        />
                    </div>
                </ActionBar>
                <SplitContainer>
                    <div className="left">
                        <div className="vehicle-details">
                            ...
                            <VehicleDetails style={{marginBottom: 70}}>
                                ...
                                <div className="stats">
                                    ...
                                    />
                                    <Typography variant="h5" noWrap className="trade"
                        ...
                        <div className="trade-info">
                            ...
                            <Statistic>
                                ...
                                <div
                                    className="value">&#8358; {tradeData.price_per_slot.toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</div>
                            </Statistic>
                            <Statistic>
                                <div className="key">ROT Per Slot</div>
                                <div
                                    className="value">&#8358; {tradeData.estimated_return_on_trade.toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</div>
                            </Statistic>
                            <Statistic>
                                <div className="key">Trading Duration in Months</div>
                                <div className="value">{Math.ceil(tradeData.estimated_sales_duration / 30)} Months</div>
                            </Statistic>
                            <Typography
                                variant="h6"
                                className="title"
                            ...
                            <Statistic>
                                ...
                                <div
                                    className="value">&#8358; {tradeData.min_sale_price.toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</div>
                            </Statistic>
                            <Statistic>
                                <div className="key">Maximum Selling Price</div>
                                <div
                                    className="value">&#8358; {tradeData.max_sale_price.toLocaleString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</div>
                            </Statistic>
                            <Statistic>
                                <div className="key">Trading Duration in Months</div>
                                <div className="value">{Math.ceil(tradeData.estimated_sales_duration / 30)} Months</div>
                        ...
                        <Grid container spacing={3}>
                            <Grid item xs={6}>
                                <PriceCard>
                                    ...
                                    <Typography
                                        variant="h5">{tradeData.slots_available - tradeData.remaining_slots}</Typography>
                                </PriceCard>
                            </Grid>
                            <Grid item xs={6}>
                                <PriceCard>
                                    <Typography variant="body1">Remaining Slot</Typography>
                                    <Typography variant="h5">{tradeData.remaining_slots}</Typography>
                                </PriceCard>
                            </Grid>
                            <Grid item xs={6}>
                                <PriceCard>
                                    <Typography variant="body1">Total Users Trading</Typography>
                                    <Typography variant="h5">{tradeData.total_users_trading}</Typography>
                                </PriceCard>
                            </Grid>
                            <Grid item xs={6}>
                                <PriceCard>
                                    ...
                                    <VehicleDetails style={{width: 700}}>
                                        ...
                                        <div className="stats">
                                            <img
                                                ...
                                                style={{marginBottom: -15}}
                                            />
                                            <Typography variant="h5" noWrap className="trade" style={{
                                                overflow: "hidden",
                                    ...
                                    <div className="content">
                                        <Grid item xs={12}>
                                            <PriceCard style={{background: t.alertSuccessLite}}>
                                                ...
                                                <Typography
                                                    variant="h5">&#8358; {((Number(tradeData.price_per_slot) * tradeData.slots_available) + tradeData.return_on_trade).toLocaleString()}</Typography>
                                            </PriceCard>
                                            <Statistic>
                                                <div className="key">Initial + ROT</div>
                                                <div className="value">&#8358; NA</div>
