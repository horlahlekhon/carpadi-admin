                                            ...
                                            >
                                                ...
                                                <TableCell align="left">
                                                    <Button
                                                        ...
                                                        width={66}
                                                        outlined={true}
                                                        onClick={() => handleNavigation(`/inventory/car-profile/${row.id}?status=available for trade`)}
                                                    />
                                                </TableCell>
                                            </TableRow>
                                        ))}
...
export default AvailableForTradePage

AvailableForTradePage.getLayout = function getLayout(page) {
