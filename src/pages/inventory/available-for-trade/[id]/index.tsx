...
function SingleAvailableForTradePage() {
                    ...
                    <div className="left">
                        <Flex>
                            ...
                            <Button text="Maintenance Record" width='100%' outlined={true} marginTop={16}
                                    marginBottom={30} onClick={() => handleNavigation('/inventory/available-for-trade/VID-110/maintenance-record')}/>
                            <CheckItem>
...
export default SingleAvailableForTradePage

SingleAvailableForTradePage.getLayout = function getLayout(page) {
