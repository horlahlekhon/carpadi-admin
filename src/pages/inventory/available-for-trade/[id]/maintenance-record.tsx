...
function SingleAvailableForTradeMaintenancePage() {
...
export default SingleAvailableForTradeMaintenancePage

SingleAvailableForTradeMaintenancePage.getLayout = function getLayout(page) {
