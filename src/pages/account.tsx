        ...
        if (response.status) {
          ...
          setPieChartData([
            ...
            },
            {
              ...
              value:
                response.data.total_withdrawals_count.total_withdrawals_count
            },
            { name: 'Total Paid Out Trade', value: 0 }
          ])
        } else {
              ...
              <MainSection>
                ...
                <Grid container spacing={3} xs={12} style={{ marginTop: 20 }}>
                  <Grid container item spacing={2} xs={8}>
                      ...
                      <Card>
                        ...
                        <Grid item>
                          ...
                          >
                            &#8358;{' '}
                            {formatNumber(
                              accountStats.total_trading_cash.total_trading_cash
                            )}
                          </Typography>
                          <Typography variant="inherit">
                            with{' '}
                            {
                              accountStats.total_trading_cash
                                .users_trading_count
                            }{' '}
                            Users
                          </Typography>
                      ...
                      <Card>
                        ...
                        <Grid item>
                          ...
                          >
                            &#8358;{' '}
                            {formatNumber(
                              accountStats.total_withdrawable_cash
                                .total_withdrawable_cash
                            )}
                          </Typography>
                          <Typography variant="inherit">
                            with {accountStats.total_withdrawable_cash.users}{' '}
                            Users
                          </Typography>
                        </Grid>
                      </Card>
                      ...
                      <Card>
                        ...
                        <Grid item>
                          ...
                          >
                            &#8358;{' '}
                            {formatNumber(
                              accountStats.total_unsettled_cash
                                .total_unsettled_cash
                            )}
                          </Typography>
                          <Typography variant="inherit">
                            with {accountStats.total_unsettled_cash.users} Users
                          </Typography>
                        </Grid>
                      </Card>
                    </Grid>
                      ...
                      <Card style={{ background: t.primaryLite, height: 190 }}>
                        ...
                        <Grid item>
                          <Typography variant="h5">
                            &#8358;{' '}
                            {formatNumber(
                              accountStats.total_transfer_charges
                                .total_transfer_charges
                            )}
                          </Typography>
                          <Typography variant="inherit">
                            with {accountStats.total_transfer_charges.users}{' '}
                            Users
                          </Typography>
                        </Grid>
                      </Card>
                    ...
                    <Grid container item xs={6}>
                      <Card
                        style={{ background: t.alertSuccessLite, height: 190 }}
                      >
                        <Typography variant="body1">
                    ...
                    <Grid container item xs={6}>
                      <Card style={{ height: 190 }}>
                        ...
                        <Grid item>
                          <Typography variant="h5">
                            {formatNumber(
                              accountStats.total_deposits_count
                                .total_deposits_count
                            )}
                          </Typography>
                          <Typography variant="inherit">
                            with {accountStats.total_deposits_count.users} Users
                          </Typography>
                        </Grid>
                      </Card>
                    </Grid>
                    <Grid container item xs={6}>
                      <Card style={{ height: 190 }}>
                        ...
                        <Grid item>
                          <Typography variant="h5">
                            {formatNumber(
                              accountStats.total_withdrawals_count
                                .total_withdrawals_count
                            )}
                          </Typography>
                          <Typography variant="inherit">
                            with {accountStats.total_withdrawals_count.users}{' '}
                            Users
                          </Typography>
                        </Grid>
                      </Card>
                      ...
                      >
                        ...
                        <Grid item>
                          <Typography variant="h5">
                            &#8358;{' '}
                            {formatNumber(
                              accountStats.total_assets.total_assets
                            )}
                          </Typography>
                          <Typography variant="inherit">
                            with {formatNumber(accountStats.total_assets.users)}{' '}
                            Users
                          </Typography>
                        </Grid>
                      </Card>
